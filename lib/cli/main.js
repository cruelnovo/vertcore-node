...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .option('-d, --datadir <dir>', 'Specify the vertcoin database directory')
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `vertcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ vertcore-node add wallet-service');
      console.log('    $ vertcore-node add insight-vtc-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ vertcore-node remove wallet-service');
      console.log('    $ vertcore-node remove insight-vtc-api');
      console.log();
    });
